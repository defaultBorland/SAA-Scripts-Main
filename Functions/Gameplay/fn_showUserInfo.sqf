...
if (_unit getVariable ["SAA_isZeus", false]) then {
	[
		[
			...
			[format["%1 | %2 | %3:%4", toUpper getText(configFile >> "CfgWorlds" >> worldName >> "description"), mapGridPosition _unit, [daytime, "HH:MM"] call BIS_fnc_timeToString], "<t align = 'left' shadow = '1' size = '0.7'>%1</t><br/>", 40]
		], 1, 1
