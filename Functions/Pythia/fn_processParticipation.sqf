...
private _additional_info = "Process Participation";
private _type = "process";
private _function = "process";

private _py_return = ["process.process", []] call py3_fnc_callExtension;
